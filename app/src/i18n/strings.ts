...
const strings: Record<string, Record<Locale, string>> = {
  ...
  'community.top_species': { es: 'Especies más avistadas', en: 'Most spotted species' },
  'community.stats': { es: 'Estadísticas del sitio', en: 'Site stats' },
  'community.total_dives': { es: 'inmersiones', en: 'dives' },
  'community.total_divers': { es: 'buzos', en: 'divers' },
  'community.unique_divers': { es: 'buzos', en: 'divers' },
  'community.total_species': { es: 'especies registradas', en: 'species recorded' },
  'community.species_count': { es: 'especies registradas', en: 'species recorded' },
  ...
  'community.no_data': { es: 'Sé el primero en registrar una inmersión aquí', en: 'Be the first to log a dive here' },
  'community.offline': { es: 'Datos comunitarios no disponibles sin conexión', en: 'Community data unavailable offline' },
  'community.recent_activity': { es: 'Actividad reciente', en: 'Recent activity' },
  'community.sightings_by_divers': { es: 'avistamientos por buzos', en: 'sightings by divers' },
  'community.spotted_at_sites': { es: 'sitios de avistamiento', en: 'sighting sites' },
  'community.no_community_sightings': { es: 'Aún no hay avistamientos comunitarios', en: 'No community sightings yet' },
  'community.times_spotted': { es: 'veces avistada', en: 'times spotted' },
